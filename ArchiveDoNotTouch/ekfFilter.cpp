...
int main()
{
    ...
    firstAccel(0) = -firstAccel(0); // TODO Check
    ...
    std::cout << "RMSE between estimated and truth roll: " << Utils::rmse(rollTruth, rollPredicted) << std::endl;
    std::cout << "MEA between estimated and truth roll: " << Utils::mea(rollTruth, rollPredicted) << std::endl;
    std::cout << "RMSE between estimated and truth pitch: " << Utils::rmse(pitchTruth, pitchPredicted) << std::endl;
    std::cout << "MEA between estimated and truth pitch: " << Utils::mea(pitchTruth, pitchPredicted) << std::endl;
}
